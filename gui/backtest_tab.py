"""Backtest tab — run historical accuracy testing across threshold/lookback grid."""
...
from core.predictor import backtest
...
class _BacktestWorker(QObject):
    ...
    def run(self):
        try:
            result = backtest(self.results_df, self.table_df,
...
class BacktestTab(QWidget):
    ...
    def _init_ui(self):
        ...
        # --- Accuracy grid ---
        grid_group = QGroupBox("Accuracy Grid (Threshold x Lookback)")
    ...
    def _on_run(self):
        ...
        self._worker = _BacktestWorker(results_df, table_df, t_min, t_max, lb_min, lb_max)
    ...
    def _on_finished(self, result: dict):
        ...
        all_acc = [accuracy[t][lb] for t in thresholds for lb in lookbacks if lb in accuracy[t]]
        ...
        for t in thresholds:
            for lb in lookbacks:
                ...
                lines.append(
                    ...
                    f"Avg odds: {os_data.get('avg', 0):.2f}"
                )
